...
```
halimaiyke@ubuntu:~/0x09$ cat 19-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x09$ ./19-main.py
[1, 2, 3]
[1, 2, 3]
[1, 2, 3]
True
False
halimaiyke@ubuntu:~/0x09$ wc -l 19-copy_list.py
3 19-copy_list.py
halimaiyke@ubuntu:~/0x09$
...
```
halimaiyke@ubuntu:~/0x09$ cat 100-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x09$ ./100-main.py | cat -e
BestSchool$
...
halimaiyke@ubuntu:~/0x09$ wc -l 100-magic_string.py
...
```
halimaiyke@ubuntu:~/0x09$ cat 101-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x09$ ./101-main.py
...
```
halimaiyke@ubuntu:/python3$ cat int.py
a = 1
b = 1
halimaiyke@ubuntu:/python3$
...
```
halimaiyke@ubuntu:/python3$ cat string.py
a = "SCHL"
b = "SCHL"
del a
del b

...
```
halimaiyke@ubuntu:~/0x06$ cat 0-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x06$ ./0-main.py
<class '0-square.Square'>
{}
halimaiyke@ubuntu:~/0x06$
...
```
halimaiyke@ubuntu:~/0x06$ cat 1-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x06$ ./1-main.py
...
```
halimaiyke@ubuntu:~/0x06$ cat 2-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x06$ ./2-main.py
...
```
halimaiyke@ubuntu:~/0x06$ cat 3-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x06$ ./3-main.py
Area: 9
'Square' object has no attribute 'size'
'Square' object has no attribute '__size'
Area: 25
...
```
halimaiyke@ubuntu:~/0x06$ cat 4-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x06$ ./4-main.py
...
```
halimaiyke@ubuntu:~/0x06$ cat 5-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x06$ ./5-main.py
###
###
###
--
...
```
halimaiyke@ubuntu:~/0x06$ cat 6-main.py
#!/usr/bin/python3
...
halimaiyke@ubuntu:~/0x06$ ./6-main.py | tr " " "_" | cat -e
###$
###$
###$
--$
